...
function showGoods({id, namn, pris, Tillverkare, Bild}){
    let html =`<li id="elementAfVaruLista${id}" class="list-none rounded-md bg-gradient-to-b from-zinc-400 to-white">`; 
    html += `<h3>Namn: ${namn} Pris: ${pris}kr Tillverkare: ${Tillverkare}</h3>`;
    html += `<p>Bild:  </p>`
    html += `<img class="max-h-60" src="https://upload.wikimedia.org/wikipedia/commons/7/7f/Generic_football.png" alt="Kunde inte hitta bild för aktuell vara">`
